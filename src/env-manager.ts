...
export const MANAGED_ENV_KEYS: ManagedEnvKey[] = [
  ...
  { key: "KIMI_API_KEY", label: "Kimi API Key", group: DIRECT_GROUP, help: "Chave da Kimi (Moonshot AI) para o perfil kimi, via endpoint compatível com a API da Anthropic. Obtenha em https://platform.kimi.ai/console/api-keys.", required: false },
